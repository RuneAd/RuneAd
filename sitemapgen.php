...
*************************************************************/
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible; iProDev PHP XML Sitemap Generator/" . VERSION . ", https://runead.com)";
	...
	fwrite ($pf, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" .
				 ...
				 "<!-- Created with RuneAd PHP XML Sitemap Generator " . VERSION . " https://runead.com -->\n" .
